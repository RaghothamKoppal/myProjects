...
public class ETL extends API_Header{
	
	
	static String testDataSheetName = "ETL"; // This test data table name is going to be same as this class name and respective test data sheet name.
	...
	public Object[][] createData1() throws IllegalFormatException, IOException, Exception {
		testDataTableName= "TC1-ColumnsMappingRequests";
	...
	public void TC1_ColumnsMappingRequests(LinkedHashMap<String,String> data) throws Exception
	{
	...
	public Object[][] createData2() throws IllegalFormatException, IOException, Exception {
		testDataTableName= "TC2-EventMappingRequests";
		dpFailedTestsMap.put(testDataTableName, extent.startTest(testDataTableName));
		testStatus.put(testDataTableName, "Skipped");
		return(getTestcaseData(testDataSheetName, testDataTableName));
	}
	@Test(dataProvider = "DP2", priority=2)
	public void TC2_EventMappingRequests(LinkedHashMap<String,String> data) throws Exception
	{
		executeTestCase(data);logger.info("Execuing the method -- TC1-ColumnsMappingRequests");
	}
	...
	public Object[][] createData3() throws IllegalFormatException, IOException, Exception {
		testDataTableName= "TC3-TransformersRequests";
		dpFailedTestsMap.put(testDataTableName, extent.startTest(testDataTableName));
		testStatus.put(testDataTableName, "Skipped");
		return(getTestcaseData(testDataSheetName, testDataTableName));
	}
	@Test(dataProvider = "DP3", priority=3)
	public void TC3_TransformersRequests(LinkedHashMap<String,String> data) throws Exception
	{
		executeTestCase(data);logger.info("Execuing the method -- TC1-ColumnsMappingRequests");
	}
