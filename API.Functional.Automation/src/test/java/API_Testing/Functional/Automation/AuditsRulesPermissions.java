...
public class AuditsRulesPermissions extends API_Header{
	
	
	static String testDataSheetName = "AuditsRulesPermissions"; // This test data table name is going to be same as this class name and respective test data sheet name.
	...
	public Object[][] createData5() throws IllegalFormatException, IOException, Exception {
		testDataTableName= "TC1-PermissionsRequests";
	...
	{
		executeTestCase(data);logger.info("Execuing the method -- TC1-PermissionsRequests");
	}
