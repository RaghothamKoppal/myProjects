...
public class AnalyticalAssets extends API_Header{
	
	static String testDataSheetName = "AnalyticalAssets"; // This test data table name is going to be same as this class name and respective test data sheet name.
	...
	public Object[][] createData1() throws IllegalFormatException, IOException, Exception {
		testDataTableName= "TC1-FilterAnalyticalAssets";
	...
	public void TC1_FilterAnalyticalAssets(LinkedHashMap<String,String> data) throws Exception
	{
		executeTestCase(data);logger.info("Execuing the method -- TC1-FilterAnalyticalAssets");
	}
	...
	public Object[][] createData2() throws IllegalFormatException, IOException, Exception {
		testDataTableName= "TC2-AddDeleteFolder";
		dpFailedTestsMap.put(testDataTableName, extent.startTest(testDataTableName));
		testStatus.put(testDataTableName, "Skipped");
		return(getTestcaseData(testDataSheetName, testDataTableName));
	}
	@Test(dataProvider = "DP2", priority=2)
	public void TC1_AddAndDeleteFolder(LinkedHashMap<String,String> data) throws Exception
	{
		executeTestCase(data);logger.info("Execuing the method -- TC1-FilterAnalyticalAssets");
	}
